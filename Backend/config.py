...
class Settings:
    ...
    def __init__(self):
        ...
        cors_env = os.getenv(
            ...
            'http://localhost:3000,http://127.0.0.1:5173,http://localhost:5174,http://127.0.0.1:5174,http://localhost:5173,https://ai-news-intelligence-platform-pxcm.onrender.com'
        )
